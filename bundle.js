...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = __webpack_require__(89);
	...
	var NotificationList = React.createClass({
	  ...
	  getMessageFromSQS: function getMessageFromSQS() {
	    var params = {
	    ...
	    this.state.sqsSession.receiveMessage(params, function (err, data) {
	      if (err) console.log(err, err.stack);else if (data.Messages.length > 0) {
	        ...
	        this.state.sqsSession.deleteMessage({
	          ...
	          if (err) console.log(err, err.stack);else console.log('Successfully Dequeued');
	        });
	      }
	    }.bind(this));
	  },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            this.state.notifications.map(function (listValue) {
	              return React.createElement(Notification, { content: listValue.message });
	            })
	          )
	        ),
	        React.createElement('div', { className: 'col-md-8 slide-fade' })
	      )
	    );
	  }
	});
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(NotificationList, null),
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  "label",
	                  { className: "col-sm-4 control-label", htmlFor: "queueName" },
	                  "Queue Name"
	                ),
	                React.createElement(
	                  "div",
	                  { className: "col-sm-8" },
	                  React.createElement("input", { type: "text", className: "form-control", id: "queueName", placeholder: "Queue Name" })
	                )
	              ),
	              React.createElement(
	                "div",
	                ...
	                React.createElement(
	                  "label",
	                  { className: "col-sm-4 control-label", htmlFor: "accessKeyId" },
	                  "Access Key ID"
	                ),
	                React.createElement(
	                  "div",
	                  { className: "col-sm-8" },
	                  React.createElement("input", { type: "text", className: "form-control", id: "accessKeyId", placeholder: "Access Key ID" })
	                )
	              ),
	              React.createElement(
	                "div",
	                ...
	                React.createElement(
	                  "label",
	                  { className: "col-sm-4 control-label", htmlFor: "secretAccessKey" },
	                  "Secret Access Key"
	                ),
	                React.createElement(
	                  "div",
	                  { className: "col-sm-8" },
	                  React.createElement("input", { type: "password", className: "form-control", id: "secretAccessKey", placeholder: "Secret Access Key" })
	                )
	              )
	            )
	          ),
